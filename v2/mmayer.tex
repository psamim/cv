...
%  \twitter{@bersam.k}
 ...
 % \linkedin{linkedin.com/in/bersam}
  \github{github.com/psamim} % I'm just making this up though.
...
\cvevent{Full Stack Developer}{\href{https://globalworkandtravel.com/}{Global Work and Travel}}{2020 -- Present}{Remote}
\begin{itemize}
\item Updated and maintained legacy code base from AngularJS to Angular 9
\item Designed deploy and test pipelines (AWS ECS, Bitbucket pipelines, bash, Docker)
\item Implemented data-intensive UIs (SASS, Angular, MySQL, REST, node, express)
\end{itemize}

\divider

\cvevent{Front-End Developer}{\href{https://darkpos.com/}{Dark POS}}{2017 -- 2019}{Remote}
\begin{itemize}
...
\cvevent{Mobile and Web developer}{\href{https://karapost.com/}{Karapost}}{2014 -- 2016}{Remote, Tehran,Iran}
\begin{itemize}
...
\cvevent{Full-stack Web Developer}{\href{https://jooyeshgar.com/}{Jooyeshgar}}{2013 -- 2014}{Esfahan, Iran}
\begin{itemize}
